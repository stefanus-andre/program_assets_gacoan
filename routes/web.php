...
Route::group([RoleMiddleware::class => ':admin'], function(){
    ...
    Route::get('/admin/get-periodic-ajax', [PeriodicMtcController::class, 'GetPeriodicMtcAjaxassets']);
...
//   Route::get('/admin/moveout', [MovementOutController::class, 'HalamanMoveOut']);
  ...
  Route::put('/moveout/update/{id}', [MovementOutController::class, 'update'])->name('moveout.update');
 ...
 Route::post('/stockopname/upload_excel', [StockOpnameController::class, 'ImportDataStockOpname'])->name('import.stockopname');
 Route::get('/assets/{id}', 'AssetController@show');
...
//  Route::get('/admin/stockopname/pdf-stockopname/{opname_id}', [StockOpnameController::class, 'previewPDF'])->name('stockopname.preview');
 Route::get('/admin/stockopname/export_pdf', [StockOpnameController::class, 'ExportPDFStockOpname']);
...
// REPORT ROUTES
 ...
 Route::get('/reports/stock_asset_per_location', [ReportController::class, 'ReportStockAsset']);
