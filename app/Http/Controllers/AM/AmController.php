...
class AmController extends Controller
{
    ...
    public function HalamanDisposalOut(Request $request) {
        ...
        return view("AM.disposal.lihat_data_disposal_out", [
            'reasons' => $reasons,
            'assets' => $assets,
            'conditions' => $conditions,
            'approvals' => $approvals,
    ...
    public function HalamanAddDataDisposalOut() {
        $reasons = DB::table('m_reason')->select('reason_id', 'reason_name')->get();
        $approvals = DB::table('mc_approval')->select('approval_id', 'approval_name')->get();
        ...
        return view('AM.disposal.add_data_disposal_out', [
    ...
    public function HalamanApprovalDisposalOutAM() {
        $reasons = DB::table('m_reason')->select('reason_id', 'reason_name')->get();
        $approvals = DB::table('mc_approval')->select('approval_id', 'approval_name')->get();
        $assets = DB::table('table_registrasi_asset')->select('id', 'asset_name')->get();
        $conditions = DB::table('m_condition')->select('condition_id', 'condition_name')->get();
        ...
        return view("AM.disposal.approval", [
            'reasons' => $reasons,
            'approvals' => $approvals,
            'assets' => $assets,
            'conditions' => $conditions,
