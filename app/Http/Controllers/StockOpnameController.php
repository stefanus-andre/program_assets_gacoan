...
class StockOpnameController extends Controller
{
    ...
    public function ExportPDFStockOpname() {
        $opnames = DB::table('t_opname_header')
            ->select('opname_id', 'opname_no', 'opname_desc', 'create_by', 'create_date') // Add 'create_by' and 'create_date' if needed
            ->get();
    
        $pdf = Pdf::loadView('Admin.export_pdf.stockopname_pdf', ['opnames' => $opnames]);
