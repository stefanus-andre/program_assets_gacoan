...
class TipeAssetController extends Controller
{
    public function Index()
    {
        ...
        return view("Admin.tipe_asset", ['types' => $types]);
    }

    public function HalamanTipe() 
    {
        $types = DB::table('m_type')->select('m_type.*')->paginate(10);
    ...
    public function AddDataTipe(Request $request)
    {
    ...
    public function updateDataTipe(Request $request, $id)
    {
        // Validasi input
        $request->validate([
            'type_code' => 'required|string|max:255',
    ...
    public function deleteDataTipe($id)
    {
