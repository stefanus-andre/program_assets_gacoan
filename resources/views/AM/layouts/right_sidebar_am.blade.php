<div class="sidebar-wrapper">
          <div>
            <div class="logo-wrapper"><a href="/am/dashboard"><img class="img-fluid for-light" src="{{asset('assets/images/header-card.png')}}"></a>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="menu-box"> 
                    <ul>
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="/am/dashboard"><i data-feather="pie-chart"></i><span>Dashboard</span></a></li>
                    ...
                    <ul>
                      <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="clipboard"></i><span>Registration</span></a>
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i data-feather="server"></i><span>Asset Transfer</span></a>
                          <ul class="sidebar-submenu">
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="/am/moveout"><span>Data Movement Out</span></a></li>
                            ...
                            @endif -->
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="/am/apprmoveout-am"><span>Approval OPS AM</span></a></li>
