                ...
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="menu-box">
                    ...
                    <li class="menu-box">
                        <ul>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/dashboard"><i data-feather="pie-chart"></i><span>Dashboard</span></a>
                            </li>
                            ...
                            <ul class="nav-sub-childmenu submenu-content">
                              ...
                              <li><a href="datatable-data-source.html">Data Sources</a></li>
                                    ...
                                    <li><a class="sidebar-link sidebar-title link-nav"
                                            href="/admin/registrasi_asset/lihat_data_registrasi_asset"><span>Assets
                                                Regist</span></a></li>
                            </li>
                            <li><a class="sidebar-link sidebar-title link-nav" href="/admin/approval-reg"><span>Approval
                                        OPS SM</span></a></li>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/moveout"><span>Request Movement Out</span></a></li>
                            <!-- @if (Auth::user() && Auth::user()->role === 'am')
<li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="/admin/apprmoveout-am"><span>Approval OPS AM</span></a></li>
@endif -->
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/apprmoveout-am"><span>Approval OPS AM</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/apprmoveout-rm"><span>Approval OPS RM</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/apprmoveout-sdgasset"><span>Approval SDG Assets</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/movein"><span>Request Movement In</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/delivery"><span>Delivery Order</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/confirm"><span>Confirm Asset</span></a></li>
                            <!-- <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="/admin/data-movement"><span>Data Movement</span></a></li> -->
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/rev-head"><span>Review Ops Head</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/rev-mnr"><span>Review MnR Area</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/rev-taf"><span>Review TAF Accounting</span></a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/disout"><span>Request Disposal</span></a></li>
                            <!-- @if (Auth::user() && Auth::user()->role === 'am')
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/apprdis-rm"><span>Approval OPS RM</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                    href="/admin/apprdis-sdgasset"><span>Approval SDG Assets</span></a></li>
                            ...
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                  href="/admin/review-disposal"><span>Review Disposal</span></a></li>
                            {{-- <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                  href="/admin/revdis-mnr"><span>Review MnR Area</span></a></li>
                            <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                  href="/admin/revdis-taf"><span>Review TAF Accounting</span></a></li> --}}
                        </ul>
                    </li>
                ...
                <li class="menu-box">
                    <ul>
                        ...
                        <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="javascript:void(0)"><i
                            ...
                            <ul class="sidebar-submenu">
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/regist"><span>Asset</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/registeqp"><span>Asset Equipment</span></a></li>
                                <!-- <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="#"><span>Merk</span></a></li> -->
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/brand"><span>Brand</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/category"><span>Kategori</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/subcategory"><span>Sub Kategori</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/checklist"><span>Checklist</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/condition"><span>Kondisi</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/control"><span>Kontrol Checklist</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/dept"><span>Departement</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/division"><span>Division</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/groupuser"><span>Group User</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/joblevel"><span>Job Level</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/layout"><span>Tata Letak</span></a></li>
                                ...
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/people"><span>People</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/type"><span>Tipe Asset</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/tipe_maintenance"><span>Tipe Maintenance Asset</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/periodic"><span>Periodic Maintenance</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/priority"><span>Prioritas</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/reason"><span>Alasan Mutasi</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/reasonso"><span>Alasan Stock Opname</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/region"><span>Regional</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/repair"><span>Perbaikan</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/supplier"><span>Pemasok</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/uom"><span>Satuan</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/warranty"><span>Garansi</span></a></li>
                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/city"><span>Kota</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/resto"><span>Resto</span></a></li>

                                <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/approval_maintenance"><span>Approval Maintenance</span></a></li>
                          ...
                          <li><a class="submenu-title" href="javascript:void(0)">Data Tables<span class="sub-arrow"><i class="fa fa-angle-right"></i></span></a>
                            <ul class="nav-sub-childmenu submenu-content">
                              ...
                              <li><a href="datatable-data-source.html">Data Sources</a></li>
                                ...
                                <li><a class="sidebar-link sidebar-title link-nav"
                                        href="/admin/user"><span>User</span></a></li>
                        </li>
                        <li><a class="sidebar-link sidebar-title link-nav"
                                href="/admin/permission"><span>Permission</span></a></li>
                </li>
                </ul>
                </ul>
                </li>
                ...
                <!-- <li><a class="sidebar-link sidebar-title link-nav" href="/reports/checklist_asset"><span>Checklist Asset</span></a></li></li> -->
                <!-- <li><a class="sidebar-link sidebar-title link-nav" href="/reports/maintenance_asset"><span>Maintenance Asset</span></a></li></li> -->
                <!-- <li><a class="sidebar-link sidebar-title link-nav" href="/reports/history_maintenance_asset"><span>History Maintenance Asset</span></a></li></li> -->
                <li><a class="sidebar-link sidebar-title link-nav"
                        href="/reports/stock_asset_per_location"><span>Stock Asset Per Location</span></a></li>
                </li>
                <!-- <li><a class="sidebar-link sidebar-title link-nav" href="/reports/garansi_asset"><span>Garansi Asset</span></a></li></li> -->
                <li><a class="sidebar-link sidebar-title link-nav" href="/reports/disposal_asset"><span>Disposal
                            Asset</span></a></li>
                </li>
                <!-- <li><a class="sidebar-link sidebar-title link-nav" href="/reports/stock_opname"><span>Stock Opname</span></a></li></li> -->
