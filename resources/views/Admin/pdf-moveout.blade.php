        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $data->type_name }}</td> ambil dari table registrasi asset berdasarkan asset_id
